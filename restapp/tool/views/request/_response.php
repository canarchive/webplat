 ...
 * @var \restapp\tool\models\ResponseRecord $record
 */
?>
    ...
    <?php if ($record->status): ?>
        ...
        <div class="tab-content">
            ...
            <div id="response-body" class="tab-pane">
                ...
                $formatterConfig = 'restapp\tool\formatters\RawFormatter';
                ...
                /** @var \restapp\tool\formatters\RawFormatter $formatter */
                $formatter = \Yii::createObject($formatterConfig);
                echo $formatter->format($record, $this);
                \restapp\tool\HighlightAsset::register($this);
