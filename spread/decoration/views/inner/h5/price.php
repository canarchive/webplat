<?php echo $this->render('_header', ['info' => $info, 'title' => '免费报价']); ?>
<body class="bj-body">
    <!--页头 start-->
    ...
    <section class="container f16">
        ...
        <div class="bj-part01-bg pd4">
            <div class="signup bg-ff">
                <ul>
					...
					<li class="mt3 f18 text-center cGray fB"><i class="iconfont icone64a mr2"></i><a href="tel:<?= $info['hotline']; ?>"><?= $info['hotline']; ?></a></li>
        ...
        <div class="part02-bg">
            ...
            <ul class="problem-item pl5 cWhite f18">
                ...
                <li class="mt5"><i class="line"></i>同样的材料，哪家装修公司报价最实惠？</li>
                <li class="mt5"><i class="line"></i>装修公司价格，便宜的不敢订，贵的又太贵！</li>
            </ul>
        </div>
        <!--传统家装有哪些痛点 end-->
