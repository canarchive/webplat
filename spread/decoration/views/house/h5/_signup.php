			<div class="sign_up" id="sign_up">
                <div class="xX xX_on">
					<P class="L_p1">一起装修网自有设计师<span>500</span>位、工长<span>200</span>位</P>
                    ...
                    <form class="form6-yuyue form6-yuyue_on">
								...
								<input type="text" name="rname" value="" class="ipt" maxlength="10" placeholder="请填写您的姓名">
                                <input type="tel" name="mobile" value="" class="ipt" maxlength="11" placeholder="填写手机号，取得免费资格">
