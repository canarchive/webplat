...
$this->params['formPosition'] = 'hd-merchant-list';
$this->params['formPositionName'] = '活动-商家列表';
    ...
    <div class="provider_advert">
        <div class="provider_advert_form">
            ...
            <div class="apply_form">
                <input name="apply_type" type="hidden" value="hd-merchant-list-right" />
...
function triggerPopForm(btn) {
    ...
    var setProvider = function(btn, container) {
		...
		$("#position_name").val(providerId + '-活动商家列表');
    };
}
