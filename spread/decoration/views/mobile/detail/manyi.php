...
<header>
    <a href="http://m.tumanyi.com/index.html" class="addres">
        <em class="ico_city"></em>
        <span id="curcity"></span>
    </a>
    <a href="javascript:;" class="logo">图满意</a></header>
<figure class="filter_img">
	<img src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/manyi/images/index_banner.png" alt="图满意比其他渠道找装修公司便宜20%">
</figure>
<nav class="index_nav">
    <ul class="clear">
        <li>
            <a href="/company/bj/" class="ico1">
				<i></i>装修公司
            </a>
        </li>
        <li>
            <a href="/case/bj/" class="ico3">
                <i></i>装修案例
            </a>
        </li>
        <li>
            <a href="/yx/shejibaojia.html" class="ico2">
                <i><em>免费</em></i>设计报价
            </a>
        </li>
        <li>
            <a href="/yx/ldzxb.html" class="ico4">
                <i></i>装修保
            </a>
        </li>
    </ul>
...
<section class="bg_eee">
        ...
        <section class="mod_form ptb15 mt10">
            ...
            <form id="bid_form">
                ...
                <span class="inp_check">
                    ...
                    <a rel="nofollow" href="http://m.tumanyi.com/about/help.html">
    ...
    <figure class="index_fig">
        <img class=" lazy" data-original="<?= Yii::getAlias('@asseturl'); ?>/spread/house/manyi/images/index_img_01.jpg" src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/manyi/images/grey.gif?v=1384541692" alt="图满意已经为全国250个城市近800万业主,提供了专业的装修服务" />
        <figcaption>
            <h1>覆盖更广</h1>
            <em class="ico_quotation"></em>
            <p>图满意已经为全国250个城市近800万业主
                <br/>提供了专业的装修服务</p></figcaption>
    </figure>
    <figure class="index_fig">
        <img class=" lazy" data-original="<?= Yii::getAlias('@asseturl'); ?>/spread/house/manyi/images/index_img_02.jpg" src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/manyi/images/grey.gif?v=1384541692" alt="96%的业主反馈，在图满意找装修公司比其他渠道便宜20%" />
        <figcaption>
            <h1>装修更省</h1>
            <em class="ico_quotation"></em>
            <p>96%的业主反馈，在图满意找装修公司
                <br/>比其他渠道便宜20%</p></figcaption>
    </figure>
    <figure class="index_fig">
        <img class=" lazy" data-original="<?= Yii::getAlias('@asseturl'); ?>/spread/house/manyi/images/index_img_03.jpg" src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/manyi/images/grey.gif?v=1384541692" alt="99%的工地证明，图满意监管严格，施工质量高于行业标准，装修质量更满意" />
        <figcaption>
            <h1>质量更好</h1>
            <em class="ico_quotation"></em>
            <p>99%的工地证明，图满意监管严格，
...
<script type="text/javascript" src="<?= Yii::getAlias('@asseturl'); ?>/spread/house/manyi/js/component.js?v=201604071507"></script>
<footer>
    <article>
        <p class="about">
            <em class="ico_about_book"></em>
            <a href="/about/jieshao.html">关于我们</a>&nbsp;&nbsp;
			<a href="/about/help.html">帮助中心</a>
        </p>
        <p class="copy">Copyright © 2015 图满意 All Rights Reserved
			<br/>粤ICP备08125558号-5
		</p>
    </article>
</footer>
...
<script type="text/javascript">/*<![CDATA[*/
seajs.use('index');
seajs.use(['bottomseo']); seajs.use('common',
function(common) {
    common.init();
});
/*]]>*/
