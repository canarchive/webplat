        ...
        <!--[if IE 8]>
            ...
            <html class='no-js'>
                ...
                <head>
                    ...
                    <title>
                        『OPPO智能手机个人首页』OPPO手机个人最新动态|历史记录查询-OPPO智能手机官网
                    </title>
                    ...
                    />
                    <link media="all" type="text/css" rel="stylesheet" href="http://www.opposhop.cn/assets/stylesheets/styles.css?v=20160214150111">
                ...
                <body>
                        ...
                        <div class='upper-area'>
                            <div class='wrapper g'>
                                ...
                                <ul class='gi log-area'>
                                    ...
                                    <li class='gi hidden hasLogin' data-desktop='.upper-area .log-area' data-mobile='.mobile-tools .log-area'>
                                        <a class='logout' href='http://my.oppo.com/auth/logout?callback=http%3A%2F%2Fwww.opposhop.cn%2Fuser%2Faddresses'>
                                            退出
                                        </a>
                                    </li>
                                    <li class='gi hasLogout' data-desktop='.upper-area .log-area' data-mobile='.mobile-tools .log-area'>
                                        <a href='http://my.oppo.com/auth/login?callback=http%3A%2F%2Fwww.opposhop.cn%2Fuser%2Faddresses'>
                                            登录
                                        </a>
                                    </li>
                                    <li class='gi hasLogout' data-desktop='.upper-area .log-area' data-mobile='.mobile-tools .log-area'>
                                        <a href='http://my.oppo.com/auth/register?callback=http%3A%2F%2Fwww.opposhop.cn%2Fuser%2Faddresses'>
                                            注册
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div class='wrapper'>
                                ...
                                <div class='shop-cart'>
                                    <a href='http://www.opposhop.cn/cart'>
                                        ...
                                        <span class='n-item-cart cart_number' id="shopping-count">
                                            0
                                        </span>
                                    </a>
                                </div>
                                ...
                                <a class='js-open-user' href='#'>
                                    <img src="http://shopfs.myoppo.com/shop/media/images/icon-menu-user.png"
                                    alt="">
                                </a>
                                <div class='main-menu'>
                                            ...
                                            <ul class='menu g'>
                                                ...
                                                '>
                                                    ...
                                                    <ul class='sub-menu'>
                                                        ...
                                                        <li>
                                                            <a href='/products?is_promotion=0&category=2'>
                                                                配件
                                                            </a>
                                                        </li>
                                                        <li>
                                    ...
                                    <div class='relative'>
                                        <ul>
                                            ...
                                            <li class='user-menu-logout'>
                                                <a href='http://my.oppo.com/auth/logout?callback=http%3A%2F%2Fwww.opposhop.cn%2Fuser%2Faddresses'>
                                                    退出
                                                </a>
                                            </li>
                                        </ul>
                        ...
                        <div class='wrapper'>
                            ...
                            <div class='myOppo-menu'>
                                ...
                                <ul class='navigation'>
                                    ...
                                    <li class=''>
                                        <a href='http://www.opposhop.cn/coupons/show'>
                                            优惠券
                                        </a>
                                    </li>
                                </ul>
                                ...
                                <div class='gi one-whole'>
                                    <div class='brick-shadow'>
                                        <div class='radio-title'>
                                            <strong>
                                                我们默认首选顺丰快递，如收货地址顺丰快递不能送达，我们会更改为EMS快递为您配送。
                                            </strong>
                                        </div>
                                        <div class="content">
                                                ...
                                                <div class='address-form' data-address-id='759531'>
                                                    <div id='address-edit-759531' class='g'>
                                                        ...
                                                        <div class='form-actions'>
                                                            <div class='pull-left'>
                                                                <a class='button-light pull-left address-update' href='javascript:;' data-id='759531'>
                                                                    保存
                                                                </a>
                                                                <a class='button-light pull-left address-cancel' href='javascript:;' data-id='759531'>
                                                                    取消
                                                                </a>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class='field radio-item dark xl'>
                                                    ...
                                                    <label for='radio759531'>
                                                        <div class="g address-form-content">
                                                            <div class="gi desk-one-fifth one-whole">
                                                                王
                                                            </div>
                                                            <div class="gi desk-one-fifth one-whole">
                                                                138 1197 4106
                                                        ...
                                                        <div class='links'>
                                                            <a onclick='vm.edit("759531")'>
                                                                编辑
                                                            </a>
                                                            <a href='javascript:;' class='remove-address' data-id='759531'>
                                                                删除
                                                            </a>
                                                        </div>
                                                    </label>
                                            ...
                                            <div class="address-form-field">
                                                <div class='address-form' data-address-id='759533'>
                                                    <div id='address-edit-759533' class='g'>
                                                        ...
                                                        <div class='form-actions'>
                                                            <div class='pull-left'>
                                                                <a class='button-light pull-left address-update' href='javascript:;' data-id='759533'>
                                                                    保存
                                                                </a>
                                                                <a class='button-light pull-left address-cancel' href='javascript:;' data-id='759533'>
                                                                    取消
                                                                </a>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class='field radio-item dark xl'>
                                                    ...
                                                    <label for='radio759533'>
                                                        ...
                                                        <div class='links'>
                                                            <a onclick='vm.edit("759533")'>
                                                                编辑
                                                            </a>
                                                            <a href='javascript:;' class='remove-address' data-id='759533'>
                                                                删除
                                                            </a>
                                                        </div>
                                                    </label>
                                        ...
                                        <a class='button-light field' id="address_new" href='javascript:;'>
                                            添加新地址
                                        </a>
                                        <div class='js-content address-form-new' style='display:none;'>
                                            <div id='address-create' class='g'>
                                                ...
                                                <div class='g field'>
                                                    ...
                                                    <div class="g">
                                                        <div class="gi desk-two-thirds one-whole">
                                                            <input class='address-detail' type="text" name="address-detail" value=''
                                                            placeholder="详细街道地址">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class='form-actions'>
                                                    <div class='pull-left'>
                                                        <a class='button-light pull-left address-store' href='javascript:;'>
                                                            保存
                                                        </a>
                                                        <a class='button-light pull-left address-new-cancel' href='javascript:;'>
                                                            取消
                                                        </a>
                                                    </div>
                                                </div>
                    ...
                    <footer class='main-footer'>
                            ...
                            <div class='wrapper'>
                                <div class='footer-social lap-one-half desk-lap-one-third'>
                                    <p>
                                        ...
                                        <a href='#' id='footer-wx' class='relative'>
                                            ...
                                            <img src="http://shopfs.myoppo.com/shop/media/images/wx.png" class="wx-float"
                                            alt="">
                                        </a>
                                ...
                                <div class='footer-subscribe lap-one-half desk-lap-one-third align-right'>
                                    ...
                                    <div class="g one-whole desk-one-half lap-one-half about-contact pull-left">
                                        <a id="btn-kf" href="http://oim.oppo.com/oim/chatClient/chatbox.jsp?companyID=8092&configID=890&enterurl=http%3A%2F%2Foim%2Emyoppo%2Ecom%2Foim%2Fpreview%2Ejsp&pagereferrer=http%3A%2F%2Foim%2Emyoppo%2Ecom%2Foim%2FembedScript%2Ejsp%3Ft%3D1517&k=1"
                                        target="_blank">
                        ...
                        <div class='footer-info'>
                            <div class='wrapper'>
                                <p>
                                    © 2005 - 2016 东莞市永盛通信科技有限公司 版权所有 粤ICP备14056724号-2 联系方式：4001-666-888
                                </p>
                            </div>
                        </div>
                    </footer>
                    ...
                    <script src="http://www.opposhop.cn/lib/regions/region0.js"></script>
                    <script src="http://www.opposhop.cn/lib/region-select.js"></script>
                    <script src="http://shopfs.myoppo.com/shop/assets/javascripts/opposhop.min.js?v=20160411114107"></script>
                    <script type="text/javascript">
                        var vm;
                    ...
                    <noscript>
                        <img src="http://sit.gentags.net/site/img?site=1351" style="border:0"
                        alt="" />
                    </noscript>
                    <script type="text/javascript">
                        $(function() {
