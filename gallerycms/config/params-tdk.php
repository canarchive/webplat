...
return [
    ...
    'decoration-company-info' => [
        ...
        'keyword' => '{{INFONAME}}网站，{{INFONAME}}介绍，{{INFONAME}}地址，{{INFONAME}}电话',
    ...
    'feature-baojia' => [
        ...
        'description' => '{{CITYNAME}}装修得花多少钱？就用55jia装修智能报价软件。只需30秒，即可免费为您获得最新装修价格报价以及装修相关明细费用。从而避开装修猫腻，让装修立省30%。',
    ],
    'feature-kaopu' => [
        'title' => '{{CITYNAME}}装修公司靠谱排行榜_{{CITYNAME}}装修公司推荐-【{{SITENAME}}】',
        'keyword' => '{{CITYNAME}}装修公司靠谱排行榜，{{CITYNAME}}装修公司推荐',
        'description' => '装修是大事，如何找到靠谱装修公司？就来【{{SITENAME}}】，55jia给大家汇集了{{CITYNAME}}装修公司靠谱排行榜大全与{{CITYNAME}}装修公司推荐，并同时提供三家装修公司让装修业主免费对比，让>装修业主真正找到靠谱装修公司。',
    ],
    'sample-index' => [
    ...
    'sample-show' => [
        'title' => "{{INFONAME}}_{{TAGSTR}}设计装潢案例_装修效果图-【{{SITENAME}}】",
        'keyword' => "{{INFONAME}},{{TAGSTR}}设计装潢案例",
