    ...
    <div class=webwidth>
        <div class=beautop>
            ...
            <div class="colist">
                <a href="http://www.wed114.cn/jiehun/hufu/" target="_blank">
                    护肤
                </a>
                <i>
                    |
                </i>
                <a href="http://www.wed114.cn/jiehun/caizhuang/" target="_blank">
                    彩妆
                </a>
                <i>
                    |
                </i>
                <a href="http://www.wed114.cn/jiehun/faxing/" target="_blank">
                    发型
                </a>
                <i>
                    |
                </i>
                <a href="http://www.wed114.cn/jiehun/fengxiong/" target="_blank">
                    丰胸
                </a>
                <i>
                    |
                </i>
                <a href="http://www.wed114.cn/jiehun/jianfei/" target="_blank">
                    减肥
                </a>
                <i>
                    |
                </i>
                <a href="http://www.wed114.cn/jiehun/suxing/" target="_blank">
                    塑形
                </a>
                <i>
                    |
                </i>
                <a href="http://www.wed114.cn/jiehun/zhengxing/" target="_blank">
                    整形
                </a>
            </div>
        </div>
                        ...
                        <dd>
                            <div class="sgimg2">
                                <a href="/jiehun/hanshihuabaotou/20160413144931.html" target=_blank>
                                    <img src="/jiehun/uploads/allimg/160413/52-1604132105430-L.jpg" alt="韩式花苞头发型扎法 独特花"
                                    />
                                </a>
                                <p class="iatit2">
                                    <em class="left-arr">
                                    </em>
                                    <a href="/jiehun/hanshihuabaotou/20160413144931.html" class="txt" target=_blank>
                                        韩式花苞头发型扎法 独特花
                                    </a>
                                    <em class="right-arr">
                                    </em>
