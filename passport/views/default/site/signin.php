...
<html class='no-js'>
    ...
    <head>
        ...
        />
        <link media="all" type="text/css" rel="stylesheet" href="http://my.oppo.com/assets/stylesheets/styles.css?v=20160214150100">
        <script src="http://shopfs.myoppo.com/my/lib/modernizr.custom.js">
        </script>
        <script type="text/javascript">
            ...
            var v = checkBrowser();
            if (!v) {
                window.location.href = "http://my.oppo.com/ltie9_message.html";
            }
        </script>
        <!--[if lt IE 9]>
            <script src="http://shopfs.myoppo.com/my/lib/html5shiv.js">
            </script>
            <script src="http://shopfs.myoppo.com/my/lib/respond.min.js">
            </script>
            <script src="http://shopfs.myoppo.com/my/lib/selectivizr-min.js">
            </script>
            <link media="all" type="text/css" rel="stylesheet" href="http://shopfs.myoppo.com/my/assets/stylesheets/ie.css">
        <![endif]-->
    </head>
    ...
    <body>
            ...
            <div class='upper-area'>
                <div class='wrapper g'>
                    ...
                    <ul class='gi log-area'>
                        ...
                        <li class='gi hidden hasLogin' data-desktop='.upper-area .log-area' data-mobile='.mobile-tools .log-area'>
                            <a class='logout' href='http://my.oppo.com/auth/logout?callback=http%3A%2F%2Fmy.oppo.com%2Fauth%2Flogin%3Fcallback%3Dhttp%253A%252F%252Fwww.oppo.com%252Fcn%252F'>
                                退出
                            </a>
                        </li>
                        <li class='gi hasLogout' data-desktop='.upper-area .log-area' data-mobile='.mobile-tools .log-area'>
                            <a href='http://my.oppo.com/auth/login?callback=http%3A%2F%2Fmy.oppo.com%2Fauth%2Flogin%3Fcallback%3Dhttp%253A%252F%252Fwww.oppo.com%252Fcn%252F'>
                                登录
                            </a>
                        </li>
                        <li class='gi hasLogout' data-desktop='.upper-area .log-area' data-mobile='.mobile-tools .log-area'>
                            <a href='http://my.oppo.com/auth/register?callback=http%3A%2F%2Fmy.oppo.com%2Fauth%2Flogin%3Fcallback%3Dhttp%253A%252F%252Fwww.oppo.com%252Fcn%252F'>
                                注册
                            </a>
                        </li>
                    </ul>
            ...
            <div class='bottom-area'>
                <div class='wrapper'>
                    ...
                    <div class='login-home'>
                        ...
                        class='hidden oppo-tj' data-tj="account|link|auth|login">
                        ...
                        class=' oppo-tj' data-tj="account|link|auth|register">
                            <span class='icons-plus icons-plus-user'>
                            </span>
                            <span>
                                注册
                        ...
                        <div class='relative'>
                            <ul>
                                ...
                                <li class='user-menu-logout'>
                                    <a href='http://my.oppo.com/auth/logout?callback=http%3A%2F%2Fmy.oppo.com%2Fauth%2Flogin%3Fcallback%3Dhttp%253A%252F%252Fwww.oppo.com%252Fcn%252F'>
                                        退出
                                    </a>
                                </li>
                            </ul>
            ...
            <div class='wrapper login'>
                <div class='g'>
                    <div class='gi desk-two-thirds login-wrapper login-ad'>
                        <a href="http://www.oppo.com/cn/product/p/r9/index.html" target="_blank">
                            <img src='/media/images/login-product-r9.png'>
                        </a>
                    </div>
                    <div class='gi desk-one-third one-whole login-wrapper login-form'>
                        ...
                        <div class='field g'>
                            <div class='gi one-half'>
                                <a href='http://my.oppo.com/user/findme?callback=http%3A%2F%2Fwww.oppo.com%2Fcn%2F'
                                class='text-green oppo-tj' data-tj="account|link|login|forget">
                                    忘记密码？
                                </a>
                            </div>
        ...
        <script type="text/javascript">
            ...
            (function() {
                var controllerNameWithAction = "AuthController@login".split('@');
