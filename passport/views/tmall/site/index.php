...
<title>个人中心-个人设置 – 我要的，才是必要的 – 必要biyao.com</title>
...
<link href="http://static.biyao.com/pc/common/css/common.css?v=biyao_61bc246" rel="stylesheet" />
		...
		<div class="per_left">
			...
			<div class="per_leftbox">
				...
				<ul>
					...
					<li class=" "><a href="/MyCenters/MyOrder.html" ><i class="f_r mcMIcon3 inline"></i>我的订单</a> </li>
...
<!--<li class=" "><a href="/MyCenter/MyIncomeRules.html" ><i class="f_r mcMIcon5 inline"></i>我的收益</a></li>-->
					<li class="a_check "><a href="/MyCenter/Profile.html" ><i class="f_r mcMIcon8 inline"></i>个人设置</a></li>
		...
		<div class="">
			<div class="relative">
				...
				<h3 class="per_title">
					...
					<a href="/MyCenter/MyAddressManager.html"><span>管理收货地址</span></a> 
					<a class="bd_r_none" href="/MyCenter/ChangePassword.html" id="forgetPasswordID"><span>修改密码</span></a>
				</h3>
			</div>
				...
				<form method="post" id="submitForm" action="">
					<table cellspacing="0" cellpadding="0" border="0"
						...
						<tbody>
							<tr>
								<th>账户名：</th>
								<td id="txtEmail">13811974106</td>
							</tr>
							<tr>
								<th>昵　称：</th>
								<td><input type="text"
									onkeyup="$(this).css('color','#000')"
									value="2862141" class="inpCom w200"
									maxlength="10" name="nickname" id="txtNickname"> <span class="col_b76 inline" id="nicknameHint"></span></td>
			...
			<div class="per_upfileImgBox clearfix">
						...
						<li>
							<form action="/MyCenter/UploadAvatar" target="uploadfile"
								...
								<a href="javascript:void(0)"
									...
									class="J_uploadfile_btn fileInput upbox1" id="ff">
								</a>
							</form>
				...
				<div class="showImgArea clearfix">
					...
					<dl class="clearfix">
						<dt>
							<div class="bigimg">
								<img width="150" height="150" onerror="javascript:this.src='http://static.biyao.com/pc/www/img/avatar/head_150.png'" src="http://static2.biyao.com/pc/www/img/avatar/head_150.png">
							</div>
							<p class="per_imgp">大尺寸头像 150*150像素</p>
						</dt>
						<dd class="mb_20">
							<div class="middleimg">
								<img width="60" height="60" onerror="javascript:this.src='http://static1.biyao.com/pc/www/img/avatar/head_150.png'" src="http://static3.biyao.com/pc/www/img/avatar/head_150.png">
							</div>
							<p class="per_imgp">中尺寸头像 60*60像素</p>
						</dd>
						<dd>
							<div class="smallimg">
								<img width="32" height="32" onerror="javascript:this.src='http://static2.biyao.com/pc/www/img/avatar/head_150.png'" src="http://static4.biyao.com/pc/www/img/avatar/head_150.png">
							</div>
						...
						<form action="/MyCenter/UploadAvatar" target="uploadfile2"
							...
							<div class="per_imgReupfile">
								<span class="posR">重新选择图片<input type="file"
									name="userfile" class="J_uploadfile_btn fileInput upbox1 "></span>
							</div>
						</form>
...
<script type="text/javascript" src="http://static4.biyao.com/pc/common/js/lazyload.js?v=biyao_80d4f78"></script>
	...
	<script src="http://static3.biyao.com/pc/www/js/mycenter/personal_upfile_img.js?v=biyao_ed7e153" type="text/javascript"></script>
<script src="http://static4.biyao.com/pc/common/js/ui/loadmask.js?v=biyao_5aac5cc"
...
var $labels = '.J_gender_select label', callback = function(that) {
	$(that).find('input').attr('checked', 'checked')
}
LT.setRadioEffect($labels, callback);
