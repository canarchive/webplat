...
<div class="menu-form">
    ...
    <?= FileUploadUI::widget([
        ...
        'url' => ['/shoot-upload/index', 'table' => 'position', 'field' => 'picture', 'id' => $model->id],
		'gallery' => true,
        'fieldOptions' => [
    ...
    <?= FileUploadUI::widget([
        ...
        'url' => ['/shoot-upload/index', 'table' => 'position', 'field' => 'picture_mobile', 'id' => $model->id],
		'gallery' => true,
        'fieldOptions' => [
    ...
    <?= FileUploadUI::widget([
        ...
        'url' => ['/shoot-upload/index', 'table' => 'position', 'field' => 'picture_ext', 'id' => $model->id],
		'gallery' => true,
        'fieldOptions' => [
