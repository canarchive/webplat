...
echo $this->render('_listinfo_owner_house', ['modelDecorationOwner' => $model, 'modelOwner' => $modelOwner, 'ownerHouseInfos' => $ownerHouseInfos]);
echo $this->render('_listinfo_callback_log', ['modelDecorationOwner' => $model, 'modelOwner' => $modelOwner, 'callbackLogInfos' => $callbackLogInfos]);
?>
<script>
