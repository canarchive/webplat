...
<table class="table table-striped table-bordered responsive">
    ...
    <tbody>
        <tr>
            ...
            <td><input type="text" name="renovation_budget" value="<?= $model->renovation_budget; ?>" onchange="updateElemForOwner('<?= $tableName; ?>', <?= $model->id; ?>, 'renovation_budget', this.value)"/></td>
            <td>
            <?= Html::dropDownList(
                'house_type', 
                $model->house_type, 
