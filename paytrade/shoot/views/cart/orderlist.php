        ...
        <div class='upper-area'>
            <div class='wrapper g'>
                ...
                <ul class='gi log-area'>
                    ...
                    <li class='gi hidden hasLogin' data-desktop='.upper-area .log-area' data-mobile='.mobile-tools .log-area'>
                        <a class='logout' href='http://my.oppo.com/auth/logout?callback=http%3A%2F%2Fwww.opposhop.cn%2Forders'>退出</a></li>
                    <li class='gi hasLogout' data-desktop='.upper-area .log-area' data-mobile='.mobile-tools .log-area'>
                        <a href='http://my.oppo.com/auth/login?callback=http%3A%2F%2Fwww.opposhop.cn%2Forders'>登录</a></li>
                    <li class='gi hasLogout' data-desktop='.upper-area .log-area' data-mobile='.mobile-tools .log-area'>
                        <a href='http://my.oppo.com/auth/register?callback=http%3A%2F%2Fwww.opposhop.cn%2Forders'>注册</a></li>
                </ul>
                    ...
                    <div class='relative'>
                        <ul>
                            ...
                            <li class='user-menu-logout'>
                                <a href='http://my.oppo.com/auth/logout?callback=http%3A%2F%2Fwww.opposhop.cn%2Forders'>退出</a></li>
                        </ul>
                    </div>
                </div>
            </div>
