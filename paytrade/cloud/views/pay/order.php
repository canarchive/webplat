...
<div class="pd_b40">
	<div class="wrap  ie78">
		<div class="mg_t20">
			...
			<ul id="d_address" class="comment_box detailed_address_list clearfix"></ul>
		</div>
		<div class="mg_t40" id="couponListView">
		...
		<div class="shoppingBox mg_t40 mg_b20">
			...
			<div class="pd20">
				<p>
					<label class="inline col_666 "> 
						<i onclick="a_need_invoice_id(this)" id="ck_is_i" class="openIcon inline cursor"></i>
					...
					<table cellspacing="0" cellpadding="0" border="0">
						<tbody>
							...
							<tr>
								...
								<td>
									<label class="col_666">
                                        <i onclick="$(this).addClass('checkedr');$('#need_invoice_2').removeClass('checkedr');$('#invoice_title_text').hide();" class="radioIcon inline cursor" id="need_invoice_1"></i> 个人
								    </label>&nbsp; &nbsp; &nbsp; 
								    <label class="col_666">
										<i onclick="$(this).addClass('checkedr');$('#need_invoice_1').removeClass('checkedr');$('#invoice_title_text').show();" class="radioIcon inline cursor" id="need_invoice_2"></i> 单位 
										<input type="text" maxlength="36" class="inpComn w200 mg_l5" id="invoice_title_text" />
                                        <i class="inline iconcom tip_right none" id="invoice_tip"></i>
									</label>
                                </td>
							</tr>
						</tbody>
		...
		<div class="mg_t20">
			...
			<input type="hidden" id="design_ids" value="[1300450000000080060, 1300490020000020000]" />
            <input type="hidden" id="product_book_ids" value="[731594, 732619]" />
						...
						<tbody>
							<tr>
								<th align="left" colspan="2">
									<!--暂时关闭IM入口，勿删-->
									<a class="inline contact_n mg_l5"  onclick="loadHuanxinWebim('user_1862140', 'supplier_45', 1862140, 'MTg2MjE0MAkKZGU5YmY3MzEtMWI0Mi00ZTZlLWI3MzAtZTE5MTYxMzM5ZWFkCQpQQwkKMTQ1NDA0NjExNzkzOQ%3D%3D%2Ft%2Fn%2Fr257EFA633271C68DB0F8ED7FC8B34ACD3527CC60', '2862141')">
									<span class="inline imIconS mg_r5"></span>
										联系商家
					</a>
			<a> <span class="inline">商家：</span> <span
										id="J_product_name " class="inline col_666">发现鞋业</span>
								</a>
								<!--暂时关闭IM入口，临时替换--> </th>
								...
								<th width="12%" align="right" class="col_999"><span
									class="mg_r20">小计</span></th>
							</tr>
						</tbody>
					</table>
				</div>
			...
			<div class='suppliergroup'
				...
				<div class="bg_fff">
					<table cellspacing="0" cellpadding="0"
						class="sop_table1 tablecount">
						<tbody>
							<tr>
								<td width="17%" align="center"><a target="_blank"
									href="http://www.biyao.com/products/1300450000000080060-0.html">
										<img class="border" width="100" height="100" alt=""
										src="http://img.biyao.com/files/temp/render_zs/result/1300450000/e882e29db6c4ae38_130045000000008_0_800/img_6_800_200.jpg" />
								</a></td>
								<td width="35%" align="left">
									<div>
										<a target="_blank"
											href="http://www.biyao.com/productS/1300450000000080060-0.html">
											<span class="col_333">尖头圆口高跟鞋 跟高65mm</span>
										</a>
										</div> <input type="hidden" class="sizeno" value=尺码:40>
									<div class="col_999 inline mg_t5">尺码:40签名：无</div>
									<br /> <a id="material_list" designid="1300450000000080060" href="#" class="col_aaa inline mg_t5 material_list">用料清单>></a> <br />
									 </td>
								<td width="10%" align="center" class="none"><span
									class="col_333">0积分</span></td>
								<td width="12%" align="center" class="col_333"><span
									class="col_666">¥299</span></td>
						...
						<tbody>
							<tr>
								...
								<th align="left" colspan="2">
									<!--暂时关闭IM入口，勿删-->
									<a> <span class="inline">商家：</span> <span
										id="J_product_name " class="inline col_666">BEHUGE家居</span>
								</a>
								<!--暂时关闭IM入口，临时替换--> </th>
								<th width="10%" align="center" class="none">可获积分</th>
								<th width="12%" align="center" class="col_999">单价</th>
			...
			<div class='suppliergroup'
				...
				<div class="bg_fff">
					<table cellspacing="0" cellpadding="0"
						...
						<tbody>
							<tr>
								<td width="17%" align="center"><a target="_blank"
									href="http://www.biyao.com/products/1300490020000020000-0.html">
										<img class="border" width="100" height="100" alt=""
										src="http://img.biyao.com/files/temp/render_zs/result/1300490020/a4dd2c66c4776bb9_130049002000002_0_800/img_6_800_200.jpg" />
								</a></td>
								<td width="35%" align="left">
									<div>
										<a target="_blank"
											href="http://www.biyao.com/productS/1300490020000020000-0.html">
											<span class="col_333">利纳斯三角懒人沙发</span>
										</a>
										</div> <input type="hidden" class="sizeno" value=规格:三角懒人沙发>
									<div class="col_999 inline mg_t5">规格:三角懒人沙发签名：无</div>
									<br /> <a id="material_list" designid="1300490020000020000" href="#" class="col_aaa inline mg_t5 material_list">用料清单>></a> <br />
									 </td>
								<td width="10%" align="center" class="none"><span
									class="col_333">0积分</span></td>
								<td width="12%" align="center" class="col_333"><span
									class="col_666">¥499</span></td>
								<td width="12%" align="center"
									class="col_333 td_buy_num relative"
									data-weight='1.0'
									data-id='732619'
									data-pt='0' data-pd='0'
									data-pc='0'
									designid="1300490020000020000"><span
									class="col_333">1</span></td>
								<td width="12%" align="center" class="col_333"><span
									class="col_333">普通包装</span> <span class="col_333">(免费)</span> </td>
								<td width="12%" align="right"><strong
									class="col_f60 mg_r20">¥499</strong></td>
							</tr>
							</tbody>
					</table>
					<input type="hidden" send_type_value="0"
				...
				<div class="paybill_title f14">
					<div class="paybilltitleIn">
						<input type="hidden" value="499.0"
							name="order_design_price"
							supplier_id="49" />
						店铺合计（含运费）：<span class="col_f60 f14 mg_r20"><span
							name="order_price"
							supplier_id="49">¥499</span></span>
					</div>
				</div>
			</div>
			</div>
		<input type="hidden" id="shop_car_id"
			value="731594|1,732619|1" />
		<input type="hidden" id="hid_designids"
			value="1300450000000080060,1300490020000020000" />
		...
		<div class="bg_fff border mg_t30  relative">
				...
				<div class="lineH30  pd_l10 pd_r20 clearfix ">
					<div class="f_r col_666 f14">
						商品总价：<span class="w80 inline t_r col_f60 pd_r5 f14"
							id="total_order_design_price">¥798</span>
					</div>
			...
			<div class="pd_t10 t_r pd_r20 mg_b20">
				<a href="/shopcars/index.html"
					class=" col_999 back_pay_btn inline f16 mg_r20">返回购物车</a> <a
					id="submitorder" href="javascript:;"
...
<script src="<?= Yii::getAlias('@asseturl/website'); ?>/basey/js/jquery/jquery.validate.js?v="></script>
<script src="<?= Yii::getAlias('@asseturl/website'); ?>/basey/js/jquery/jquery.tabso.js?v="></script>
<script src="<?= Yii::getAlias('@asseturl/website'); ?>/basey/js/buy/ConfirmOrderDes.js?v="></script>
...
<script src="<?= Yii::getAlias('@asseturl/website'); ?>/basey/js/jquery/jquery.cookie.js?v="></script>
