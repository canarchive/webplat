...
<div class="off-canvas-wrap">
    <div class="inner-wrap">
        <header class="header hide-for-small">
            <div class="logo">
			    <a href="<?= Url::to(['/info/index']); ?>">Tuanjiahui</a>
            </div>
            <nav class="nav">
			    <a class="link active" href="<?= Url::to(['/info/index']); ?>">个人面板</a>
			    <a class="link " href="<?= Url::to(['/merchant/index']); ?>">公司信息</a>
			    <a class="link " href="<?= Url::to(['/owner/index']); ?>">业主信息</a>
            </nav>
        ...
        <aside class="right-off-canvas-menu side-panel">
            ...
            <nav class="nav">
                <ul class="nav-list">
                    ...
                    <li><a href="<?= Url::to(['/merchant/index']); ?>" title="充值">公司信息</a></li>
                    <li><a href="<?= Url::to(['/owner/index']); ?>" title="充值">业主信息</a></li>
                    <li>
